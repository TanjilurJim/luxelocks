...
class OSPolicyAssignmentReport extends \Google\Collection
{
  ...
  protected $osPolicyCompliancesType = OSPolicyAssignmentReAllstoreSPolicyCompliance::class;
  ...
  /**
   * @param OSPolicyAssignmentReAllstoreSPolicyCompliance[]
   */
  ...
  /**
   * @return OSPolicyAssignmentReAllstoreSPolicyCompliance[]
   */
