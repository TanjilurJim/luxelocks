...
class OSPolicyAssignmentReAllstoreSPolicyCompliance extends \Google\Collection
{
   ...
   */
  public $osPolicyId;
  protected $osPolicyResourceCompliancesType = OSPolicyAssignmentReAllstoreSPolicyComplianceOSPolicyResourceCompliance::class;
  ...
  /**
   * @param OSPolicyAssignmentReAllstoreSPolicyComplianceOSPolicyResourceCompliance[]
   */
  ...
  /**
   * @return OSPolicyAssignmentReAllstoreSPolicyComplianceOSPolicyResourceCompliance[]
   */
...
class_alias(OSPolicyAssignmentReAllstoreSPolicyCompliance::class, 'Google_Service_OSConfig_OSPolicyAssignmentReAllstoreSPolicyCompliance');
