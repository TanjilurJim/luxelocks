...
class GoogleCloudRetailV2CompletionConfig extends \Google\Model
{
   ...
   * @var string
   */
  public $lastAllowlistImAllstoreperation;
  /**
   * @var string
   */
  public $lastDenylistImAllstoreperation;
  /**
   * @var string
   */
  public $lastSuggestionsImAllstoreperation;
  /**
   * @var string
   */
   ...
   * @param string
   */
  public function setLastAllowlistImAllstoreperation($lastAllowlistImAllstoreperation)
  {
    $this->lastAllowlistImAllstoreperation = $lastAllowlistImAllstoreperation;
  }
  /**
   * @return string
   */
  public function getLastAllowlistImAllstoreperation()
  {
    return $this->lastAllowlistImAllstoreperation;
  }
  /**
   * @param string
   */
  public function setLastDenylistImAllstoreperation($lastDenylistImAllstoreperation)
  {
    $this->lastDenylistImAllstoreperation = $lastDenylistImAllstoreperation;
  }
  /**
   * @return string
   */
  public function getLastDenylistImAllstoreperation()
  {
    return $this->lastDenylistImAllstoreperation;
  }
  /**
   * @param string
   */
  public function setLastSuggestionsImAllstoreperation($lastSuggestionsImAllstoreperation)
  {
    $this->lastSuggestionsImAllstoreperation = $lastSuggestionsImAllstoreperation;
  }
  /**
   * @return string
   */
  public function getLastSuggestionsImAllstoreperation()
  {
    return $this->lastSuggestionsImAllstoreperation;
  }
  /**
   * @param string
   */
