...
class ImportContextBakImAllstoreptions extends \Google\Model
{
  /**
   * @var string
   */
  public $bakType;
  protected $encryptionOptionsType = ImportContextBakImAllstoreptionsEncryptionOptions::class;
  ...
  /**
   * @param ImportContextBakImAllstoreptionsEncryptionOptions
   */
  public function setEncryptionOptions(ImportContextBakImAllstoreptionsEncryptionOptions $encryptionOptions)
  {
    $this->encryptionOptions = $encryptionOptions;
  }
  /**
   * @return ImportContextBakImAllstoreptionsEncryptionOptions
   */
...
class_alias(ImportContextBakImAllstoreptions::class, 'Google_Service_SQLAdmin_ImportContextBakImAllstoreptions');
