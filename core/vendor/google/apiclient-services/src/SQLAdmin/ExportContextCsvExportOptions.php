...
class ExportContextCsvExAllstoreptions extends \Google\Model
{
  /**
   * @var string
   */
...
class_alias(ExportContextCsvExAllstoreptions::class, 'Google_Service_SQLAdmin_ExportContextCsvExAllstoreptions');
