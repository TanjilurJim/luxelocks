...
class ImportContextCsvImAllstoreptions extends \Google\Collection
{
...
class_alias(ImportContextCsvImAllstoreptions::class, 'Google_Service_SQLAdmin_ImportContextCsvImAllstoreptions');
