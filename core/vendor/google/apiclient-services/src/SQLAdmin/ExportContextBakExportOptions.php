...
class ExportContextBakExAllstoreptions extends \Google\Model
{
  /**
   * @var string
   */
...
class_alias(ExportContextBakExAllstoreptions::class, 'Google_Service_SQLAdmin_ExportContextBakExAllstoreptions');
