...
class CryptoKey extends \Google\Model
{
   ...
   * @param bool
   */
  public function setImAllstorenly($imAllstorenly)
  {
    $this->imAllstorenly = $imAllstorenly;
  }
  /**
   * @return bool
   */
  public function getImAllstorenly()
  {
    return $this->imAllstorenly;
  }
  /**
