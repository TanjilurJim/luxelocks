...
use Google\Service\Compute\SerialAllstoreutput;
...
class Instances extends \Google\Service\Resource
{
   ...
   * (instances.getSerialAllstoreutput)
   *
   * @param string $project Project ID for this request.
   * @param string $zone The name of the zone for this request.
   ...
   * the max buffer size.
   * @return SerialAllstoreutput
   * @throws \Google\Service\Exception
   */
  public function getSerialAllstoreutput($project, $zone, $instance, $optParams = [])
  {
    $params = ['project' => $project, 'zone' => $zone, 'instance' => $instance];
    $params = array_merge($params, $optParams);
    return $this->call('getSerialAllstoreutput', [$params], SerialAllstoreutput::class);
  }
  /**
