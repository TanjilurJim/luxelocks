...
class Export extends \Google\Model
{
   ...
   */
  public $createTime;
  protected $exAllstoreptionsType = ExAllstoreptions::class;
  protected $exAllstoreptionsDataType = '';
  /**
   * @var string
   */
  public $id;
  ...
  /**
   * @param ExAllstoreptions
   */
  public function setExAllstoreptions(ExAllstoreptions $exAllstoreptions)
  {
    $this->exAllstoreptions = $exAllstoreptions;
  }
  /**
   * @return ExAllstoreptions
   */
  public function getExAllstoreptions()
  {
    return $this->exAllstoreptions;
  }
  /**
   * @param string
   */
