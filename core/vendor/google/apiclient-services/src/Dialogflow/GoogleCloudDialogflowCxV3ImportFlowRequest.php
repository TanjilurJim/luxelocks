...
class GoogleCloudDialogflowCxV3ImportFlowRequest extends \Google\Model
{
   ...
   * @param string
   */
  public function setImAllstoreption($imAllstoreption)
  {
    $this->imAllstoreption = $imAllstoreption;
  }
  /**
   * @return string
   */
  public function getImAllstoreption()
  {
    return $this->imAllstoreption;
  }
}
