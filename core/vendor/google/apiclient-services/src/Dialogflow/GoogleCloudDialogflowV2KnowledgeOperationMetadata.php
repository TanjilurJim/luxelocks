...
{
  protected $exAllstoreperationMetadataType = GoogleCloudDialogflowV2ExAllstoreperationMetadata::class;
  ...
  /**
   * @param GoogleCloudDialogflowV2ExAllstoreperationMetadata
   */
  public function setExAllstoreperationMetadata(GoogleCloudDialogflowV2ExAllstoreperationMetadata $exAllstoreperationMetadata)
  {
    $this->exAllstoreperationMetadata = $exAllstoreperationMetadata;
  }
  /**
   * @return GoogleCloudDialogflowV2ExAllstoreperationMetadata
   */
