...
Route::middleware('admin')->group(function () {
    ...
    Route::prefix('quotes')->name('quotes.')->group(function () {
        // Example: All quotes
        Route::get('/', [QuoteAdminController::class, 'index'])->name('index');

        // Example: Pending quotes
        Route::get('/pending', [QuoteAdminController::class, 'pending'])->name('pending');

        // Example: Approved quotes
        Route::get('/approved', [QuoteAdminController::class, 'approved'])->name('approved');

        // Example: Show single quote details
        Route::get('/{quote}', [QuoteAdminController::class, 'show'])->name('show');

        // Approve / Reject endpoints
        Route::post('/approve/{quote}', [QuoteAdminController::class, 'approve'])->name('approve');
        Route::post('/reject/{quote}', [QuoteAdminController::class, 'reject'])->name('reject');
    });
