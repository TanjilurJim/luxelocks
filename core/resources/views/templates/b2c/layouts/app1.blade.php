...
<head>
	...
	<script>
		...
		( function ( d ) {
			...
			wf.src = '{{ asset("assets/b2c/assets/b2c/assets/js/webfont.js") }}';
			wf.async = true;
    ...
    <link rel="stylesheet" type="text/css"
        ...
        <link rel="stylesheet" href="{{ asset('assets/b2c/assets/css/demo4.min.css') }}">

	<!-- Main CSS File -->
	<link rel="stylesheet" href="{{ asset('assets/b2c/assets/css/style.min.css') }}">
				...
				<div class="container">
					<div class="header-left col-lg-2 w-auto pl-0">
						...
						<a href="demo4.html" class="logo">
							<img src="assets/images/logo.png" width="111" height="44" alt="All Store Logo">
						</a>
					</div><!-- End .header-left -->
					...
					<nav class="main-nav w-100">
						<ul class="menu">
							...
							<li class="float-right"><a href="#" class="pl-5"
									target="_blank">Buy All Store!</a></li>
...
@yield('content')
						...
						<div class="col-lg-3 col-sm-6">
							<div class="widget">
								...
								<ul class="contact-info">
									...
									<li>
										<span class="contact-info-label">Email:</span> <a href="https://portotheme.com/cdn-cgi/l/email-protection#0469656d6844617c65697468612a676b69"><span class="__cf_email__" data-cfemail="bed3dfd7d2fedbc6dfd3ced2db90ddd1d3">[email&#160;protected]</span></a>
									</li>
									<li>
	...
	<!-- Plugins JS File -->
	<script data-cfasync="false" src="{{ asset('assets/b2c/../../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js') }}"></script>
