...
<br><br>
        ...
        <div class="form-group">
            <label for="Registration-name">Full Name <span class="required text-danger">*</span></label>
            <input type="text" class="form-control" id="Registration-name" name="name" placeholder="Enter your full name" required />
        </div>

        <div class="form-group">
            <label for="Registration-email">Email Address <span class="required text-danger">*</span></label>
            <input type="email" class="form-control" id="Registration-email" name="email" placeholder="Enter your email" required />
        </div>

        <div class="form-group">
            <label for="Registration-number">Phone Number <span class="required text-danger">*</span></label>
            <input type="tel" class="form-control" id="Registration-number" name="number" placeholder="Enter your phone number" required />
        </div>

        <div class="form-group">
            <label for="Registration-password">Password <span class="required text-danger">*</span></label>
            <input type="password" class="form-control" id="Registration-password" name="password" placeholder="Enter your password" required />
        </div>
        ...
        <div class="form-footer d-flex justify-content-between align-items-center mb-3">
            ...
            <a href="{{ route('user.login') }}" style="color: #000; text-decoration: none;" onmouseover="this.style.color='#7B0405'; this.style.textDecoration='underline';" onmouseout="this.style.color='#000'; this.style.textDecoration='none';">
                Already have an account?
            </a>
        </div>

        <button type="submit" class="btn btn-block btn-lg btn-maroon mt-3">Register</button>
    </form>
