...
@section('style')
	...
	<link rel="stylesheet" type="text/css" href="{{ asset('assets/b2c/assets/vendor/simple-line-icons/css/simple-line-icons.min.css') }}">
@endsection
@section('content')
...
@endsection
>>>>>>> 2039a498adc0a0c932b4044d1cc8398861a36a42
