...
@section('app')
    <header class="sticky top-0 z-50">
        <div class="flex justify-between items-center bg-[#000206] md:px-10 px-[10px] md:py-[16px] py-[10px]">
            ...
            <a class="text-[14px] font-bold text-white xl:block hidden" href="{{ route('login') }}">ARE YOU A SALON
                PROFESSIONAL? <span class="underline">
                    Click to open a
            ...
            <div class="flex items-center gap-5 hidden">
                ...
                <div class="relative">
                    <button id="languageButton"
                        class="bg-[#000206] text-white md:text-[16px] text-[12px] flex items-center gap-2">
                        <img class="md:h-3 h-2 md:w-[18px] w-[14px]"
                            src="{{ asset('assets/north_hair_product/assets/images/en_US_flag.webp') }}" alt="English">
                    ...
                    <div id="languageDropdown"
                        ...
                        <a class="flex items-center gap-2 md:px-4 px-2 md:pr-10 pr-6 py-2 hover:bg-gray-700 transition-all duration-200"
                            href="#"><img class="md:h-3 h-2 md:w-[18px] w-[14px]"
                                src="{{ asset('assets/north_hair_product/assets/images/en_US_flag.webp') }}" alt="English">
                            English</a>
                        <a class="flex items-center gap-2 md:px-4 px-2 md:pr-10 pr-6 py-2 hover:bg-gray-700 transition-all duration-200"
                            href="#"><img class="md:h-3 h-2 md:w-[18px] w-[14px]"
                                src="{{ asset('assets/north_hair_product/assets/images/it.svg') }}" alt="Italiano">
                            Italiano</a>
                        <a class="flex items-center gap-2 md:px-4 px-2 md:pr-10 pr-6 py-2 hover:bg-gray-700 transition-all duration-200"
                            href="#"><img class="md:h-3 h-2 md:w-[18px] w-[14px]"
                                src="{{ asset('assets/north_hair_product/assets/images/fr.svg') }}" alt="Francais">
                            Francais</a>
                        <a class="flex items-center gap-2 md:px-4 px-2 md:pr-10 pr-6 py-2 hover:bg-gray-700 transition-all duration-200"
                            href="#"><img class="md:h-3 h-2 md:w-[18px] w-[14px]"
                                src="{{ asset('assets/north_hair_product/assets/images/es.svg') }}" alt="Espanol">
                            Espanol</a>
                        <a class="flex items-center gap-2 md:px-4 px-2 md:pr-10 pr-6 py-2 hover:bg-gray-700 transition-all duration-200"
                            href="#"><img class="md:h-3 h-2 md:w-[18px] w-[14px]"
                                src="{{ asset('assets/north_hair_product/assets/images/de.svg') }}" alt="Deutsch">
                            Deutsch</a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="grid grid-cols-3">
                        <div class="flex items-center w-full">
                            <a href="{{ route('home') }}" class="flex items-center">
                                <img src="{{ asset('assets/images/updatedlogo.webp') }}" alt="North Hair"
                                    class="h-6 w-auto">
                            </a>
                        </div>
                        ...
                        <div class="hidden md:flex items-center justify-center w-full">
                            ...
                            <div id="clearance-link" class="nav-link text-[#1F2124] py-5 px-4 font-[900]">Clearance</div>
                            <a href="{{ route('hair-system-supplies') }}"
                                class="nav-link text-[#1F2124] py-5 px-4 font-[900]">Supplies</a>
                            <a href="{{ route('about') }}" class="nav-link text-[#1F2124] py-5 px-4 font-[900]">About</a>
                            <a class="hidden" id="support-link" href="#"
                                class="nav-link text-[#1F2124] py-5 px-4 font-[900]">Support</a>
                        </div>
                        @php
                            // Get the cart array from the session (or an empty array if none)
                        ...
                        <div class="flex items-center justify-end space-x-6 w-full">
                            @if (auth()->check())
                                ...
                                <form action="{{ route('logout') }}" method="POST" style="display: inline;">
                                    @csrf
                                    <button type="submit" class="text-[#1F2124] font-bold flex items-center">
                            ...
                            @else
                                ...
                                <a href="{{ route('login') }}" class="text-[#1F2124] font-bold flex items-center">
                                    <svg class="h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                        <path
                                            d="M304 128a80 80 0 1 0 -160 0 80 80 0 1 0 160 0zM96 128a128 128 0 1 1 256 0A128 128 0 1 1 96 128zM49.3 464l349.5 0c-8.9-63.3-63.3-112-129-112l-91.4 0c-65.7 0-120.1 48.7-129 112zM0 482.3C0 383.8 79.8 304 178.3 304l91.4 0C368.2 304 448 383.8 448 482.3c0 16.4-13.3 29.7-29.7 29.7L29.7 512C13.3 512 0 498.7 0 482.3z" />
                                    </svg>
                            ...
                            <a href="{{ route('quote') }}" class="text-[#1F2124] font-bold flex items-center gap-1">
                                <span
                                    class="bg-yellow-400 text-[12px] font-normal rounded-full w-4 flex items-center justify-center">
                                    {{ $cartCount }}
                                </span>
                                Cart
                            </a>
        ...
        <div class="lg:hidden block">
            <nav class="bg-white shadow-lg">
                <div class="flex justify-between items-center px-4 py-3">
                    ...
                    <a href="{{ route('home') }}" class="flex items-center ml-5">
                        <img src="{{ asset('assets/images/updatedlogo.webp') }}" alt="Logo"
                            class="sm:h-6 h-4 w-auto">
                    </a>
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <a href="{{ route('quote') }}" class="flex items-center text-gray-700">
                            <span
                ...
                <div id="menu"
                    class="h-0 overflow-hidden absolute top-full left-0 z-50
            transition-all duration-300 ease-in-out bg-white w-full">
                    <div class="flex flex-col gap-3 px-4 py-3">
                        <div class="relative">
                            <button class="menu-item text-gray-700 font-bold flex justify-between w-full">
                                Men
                                <svg class="h-4 w-4 dropdown-icon" fill="none" stroke="currentColor" stroke-width="2"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7"></path>
                                </svg>
                            </button>
                            <div
                                class="submenu hidden bg-gray-100 p-2 rounded max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
                                <a href="{{ route('mens_hair_system') }}" class="block text-gray-700 py-1">Men</a>
                                <a href="{{ route('mens_stock_hair_system') }}"
                                    class="block text-gray-700 py-1">Stock</a>
                                <a href="{{ route('mens_afro_hair_system') }}" class="block text-gray-700 py-1">Afro</a>
                                <a href="{{ route('mens_lace_hair_system') }}" class="block text-gray-700 py-1">Lace</a>
                                <a href="{{ route('mens_skin_hair_system') }}" class="block text-gray-700 py-1">Skin</a>
                                <a href="{{ route('mens_mono_hair_system') }}" class="block text-gray-700 py-1">Mono</a>
                                <a href="{{ route('mens_frontal_hair_system') }}" class="block text-gray-700 py-1">Front
                                    & Partial</a>
                                <a href="{{ route('mens_crown_hair_system') }}"
                                    class="block text-gray-700 py-1">Crown</a>
                                <a href="{{ route('mens_cap_hair_system') }}" class="block text-gray-700 py-1">Full
                                    Cap</a>
                            </div>
                        </div>
                        <div class="relative">
                            ...
                            <div
                                class="submenu hidden bg-gray-100 p-2 rounded max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
                                <a href="{{ route('women') }}" class="block text-gray-700 py-1">Women</a>
                                <a href="{{ route('women_toppers') }}" class="block text-gray-700 py-1">Hair Toppers</a>
                                <a href="{{ route('women_integrations') }}" class="block text-gray-700 py-1">Hair
                                    Integration
                                    Systems</a>
                                <a href="{{ route('women_systems') }}" class="block text-gray-700 py-1">Hair Systems for
                                    Women</a>
                                <a href="{{ route('women_wigs') }}" class="block text-gray-700 py-1">Human Hair Wigs</a>
                                <a href="{{ route('women_medical') }}" class="block text-gray-700 py-1">Medical Grade
                                    Wigs</a>
                            </div>
                        </div>
                        <div class="relative">
                            ...
                            <div
                                class="submenu hidden bg-gray-100 p-2 rounded max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
                                <a href="{{ route('extensions') }}" class="block text-gray-700 py-1">Extensions</a>
                                <a href="{{ route('extensions_fusion') }}" class="block text-gray-700 py-1">Fusion /
                                    Keratin</a>
                                <a href="{{ route('extensions_tape') }}" class="block text-gray-700 py-1">Tape-in</a>
                                <a href="{{ route('extensions_sew') }}" class="block text-gray-700 py-1">Sew-in-Weft</a>
                                <a href="{{ route('extensions_clip') }}" class="block text-gray-700 py-1">Clip-in</a>
                                <a href="{{ route('extensions_tools') }}" class="block text-gray-700 py-1">Tools &
                                    Accessories</a>
                            </div>
                        </div>
                        <div class="relative">
                            ...
                            <div
                                class="submenu hidden bg-gray-100 p-2 rounded max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
                                <a href="{{ route('clearance-hair-system') }}" class="block text-gray-700 py-1">Hair
                                    Systems on
                                    Sale</a>
                                <a href="{{ route('clearance-hair-extension') }}" class="block text-gray-700 py-1">Hair
                                    Extensions on
                                    Sale</a>
                            </div>
                        </div>
                        <div class="relative">
                            <a href="{{ route('hair-system-supplies') }}"
                                class="menu-item text-gray-700 font-bold flex justify-between w-full">
                                Supplies
                            </a>
                        </div>
                        <div class="relative">
    ...
    <div class="position-fixed top-3 start-50 translate-middle-x z-50" style="max-width: 400px;">
        @if (session('success'))
    ...
    <footer class="">
        ...
        <div class="bg-[#1C1C1C] py-10">
            <div class="max-w-screen-xl mx-auto grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-4 px-4">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    policy</a> --}}
                    <a class="text-white text-[15px] hover:text-[#F9D161] transition-all duration-300"
                        href="{{ route('privacy-policies') }}">Privacy
                        policy</a>
                    <a class="text-white text-[15px] hover:text-[#F9D161] transition-all duration-300"
                        ...
                        conditions</a>
                    <a class="text-white text-[15px] hover:text-[#F9D161] transition-all duration-300"
                        href="{{ route('locationshipto') }}">Locations we
                        ship to</a>
                    <a class="text-white text-[15px] hover:text-[#F9D161] transition-all duration-300"
                        href="{{ route('copyright') }}">Customer
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <div class="mb-2">
                        ...
                        <p class="text-white">Email: <a
                                class="text-white text-[15px] hover:text-[#F9D161] transition-all duration-300"
                                href="mailto:ussales@Luxelocks.com">ussales@Luxelocks.com</a></p>
                    </div>
                    <div class="mb-2">
                    ...
                    <div class="mb-2">
                        ...
                        <p class="text-white">Email: <a
                                class="text-white text-[15px] hover:text-[#F9D161] transition-all duration-300"
                                href="mailto:info@Luxelocks.com">info@Luxelocks.com</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-[#1C1C1C] px-4 flex flex-col items-center py-5 border-t">
            ...
            <p class="text-white mt-2 mb-4">Wholesale human hair replacement system, wig and hair extension
                manufacturer.</p>
            <p class="text-white">© 2025 LUXELOCKS Products. All rights reserved.</p>
        </div>
    </footer>
    <script>
            ...
            setTimeout(() => {
                ...
                alerts.forEach(alert => {
                    if (alert.classList.contains('show')) {
                        ...
                        alert.classList.add('fade'); // Smooth fade out
                        setTimeout(() => {
                            alert.remove(); // Completely remove the alert after fade out
                        }, 500); // Give fade animation time
                    }
                });
