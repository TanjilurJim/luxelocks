                ...
                <div class=" md:px-10 px-[10px]">
                    <div class="grid grid-cols-3">
                        <div class="flex items-center w-full">
                            <a href="/northhariproduct/" class="flex items-center">
                                <img src="{{ asset('assets/northtimehair/assets/images/logo.webp') }}" alt="Logo"
                                    class="h-6 w-auto">
                            </a>
                        </div>
                        ...
                        <div class="hidden md:flex items-center justify-center w-full">
                            ...
                            <a href="hair-system-supplies.html"
                        ...
                        <div class="flex items-center justify-end space-x-6 w-full">
                            <button class="text-[#1F2124] font-bold"><svg class="h-4 w-4" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 512 512">
                                    <path
                                    ...
                                    <button type="submit" class="text-[#1F2124] font-bold flex items-center">
                                        <svg class="h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                            <path fill="currentColor"
                                                d="M497 273 335 441c-9 10-25 11-35 2s-11-25-2-35l119-130H192c-14 0-25-11-25-25s11-25 25-25h225L298 103c-9-10-8-26 2-35s26-8 35 2l162 168c9 10 9 26 0 36zM48 64h176c14 0 24-11 24-24S238 16 224 16H48C22 16 0 38 0 64v384c0 26 22 48 48 48h176c14 0 24-11 24-24s-11-24-24-24H48V64z" />
                                        </svg>
                                        Logout
                                    </button>
                                </form>
                            ...
                            <a href="{{ route('quote') }}" class="text-[#1F2124] font-bold flex items-center gap-1">
                                <span
                                    class="bg-yellow-400 text-[12px] font-normal rounded-full w-4 flex items-center justify-center">{{count( session()->get('cart', []))}}</span>
                                Cart
                            </a>
                        </div>
                    </div>
        ...
        <div id="dropdown-section" class="hidden bg-white shadow-lg px-10 py-4 absolute w-full z-10">
            ...
            <div id="clearance-dropdown" class="hidden">
                <div class="flex gap-[100px] justify-center ">
                    <div class="flex flex-col gap-3">
                        <a class="text-[#444444] font-[14px] hover:text-black transition-all duration-300"
                            href="mens-hair-pieces-for-sale.html">Hair Systems on
                            Sale</a>
                    </div>
                    <div class="flex flex-col gap-3">
                        <a class="text-[#444444] font-[14px] hover:text-black transition-all duration-300"
                            href="hair-extensions-for-sale.html">Hair Extensions on
                            Sale</a>
                    </div>
                </div>
            </div>
            ...
            <nav class="bg-white shadow-lg">
                <div class="flex justify-between items-center px-4 py-3">
                    ...
                    <a href="index.html" class="flex items-center">
                        <img src="assets/images/logo.webp" alt="Logo" class="sm:h-6 h-4 w-auto">
                    </a>
