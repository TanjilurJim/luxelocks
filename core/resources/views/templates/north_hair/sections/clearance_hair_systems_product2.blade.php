@php
    $content = getContent('clearance_hair_systems_product2.content', true);
...
@if ($data_values)
    ...
    <section>
        <div class="max-w-screen-xl mx-auto px-4 mt-2">
            <h2 class="md:text-[30px] text-[26px] font-bold text-center">{{ $data_values->title }}</h2>
            <p class="text-[#444444] text-center">{{ $data_values->details }}</p>
        </div>
    </section>
@endif
