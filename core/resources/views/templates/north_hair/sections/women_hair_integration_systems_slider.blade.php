@php
    $content = getMultipleContent('women_hair_integration_systems_slider.element', true);
@endphp
<!-- Slider -->
@if ($content)
<section>
        ...
        @foreach($content as $slider)
            ...
            <div class="relative">
                ...
                <img src="{{ property_exists($dataValues, 'slider_banner') && $dataValues->slider_banner
                        ? asset('assets/images/frontend/women_hair_integration_systems_slider/' . $dataValues->slider_banner)
