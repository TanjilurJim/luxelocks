@php
    $content = getContent('mens_mono_hair_system_comparison.content', true);
    $element = getMultipleContent('mens_mono_hair_system_comparison.element', true);
        ...
        <div>
            ...
            <div class="max-w-screen-xl mx-auto px-4 grid md:grid-cols-3 grid-cols-1 gap-10">
                @foreach ($element as $element)
                    ...
                    @endphp
                <div class="relative">
                    <img src="{{ $dataValues->comparison ? asset('assets/images/frontend/mens_mono_hair_system_comparison/' . $dataValues->comparison) : '' }}" alt="Hair Systems" class="w-full">
