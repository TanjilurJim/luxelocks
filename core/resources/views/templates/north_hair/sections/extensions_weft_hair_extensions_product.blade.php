@php
    // Get the content for the Weft Hair Extensions Section
    $content = getContent('extensions_weft_hair_extensions_product.', true);
...
@if ($data_values)
    ...
    <section>
        <div class="max-w-screen-xl mx-auto px-4 mt-2">
            <h2 class="md:text-[30px] text-[26px] font-bold">{{ $data_values->title ?? 'Weft Hair Extensions' }}</h2>
