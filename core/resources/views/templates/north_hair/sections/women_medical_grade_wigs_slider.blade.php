@php
    $content = getMultipleContent('women_medical_grade_wigs_slider.element', true);
@endphp
        ...
        @foreach($content as $slider)
            ...
            <div class="relative">
                ...
                <img src="{{ property_exists($dataValues, 'slider_banner') && $dataValues->slider_banner
                        ? asset('assets/images/frontend/women_medical_grade_wigs_slider/' . $dataValues->slider_banner)
                        : asset('assets/images/advertise-banner.webp') }}"
                     alt="{{ $dataValues->title ?? 'women-wigs-and-toppers' }}"
                     class="w-full 2xl:h-[612px] xl:h-[465px] lg:h-[350px] md:h-[267px] sm:block hidden">
