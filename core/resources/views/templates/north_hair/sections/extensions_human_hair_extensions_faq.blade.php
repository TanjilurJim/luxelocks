@php
// dd($faqSection);
$faqSection = getMultipleContent('extensions_human_hair_extensions_faq.element', true);

@endphp


@if ($faqSection && is_iterable($faqSection))

    <!-- FAQ Section -->
    <section>
        <h2 class="text-[24px] font-bold text-center mt-10">FAQs</h2>
