@php
    $content = getMultipleContent('women_wigs_and_toppers_slider.element', true);
@endphp
        ...
        @foreach($content as $slider)
            ...
            <div class="relative">
                ...
                <img src="{{ property_exists($dataValues, 'slider_banner') && $dataValues->slider_banner
                        ? asset('assets/images/frontend/women_wigs_and_toppers_slider/' . $dataValues->slider_banner)
