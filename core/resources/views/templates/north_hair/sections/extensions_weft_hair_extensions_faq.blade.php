@php
    $faq_content = getMultipleContent('extensions_weft_hair_extensions_faq.element', true);
    // dd($faq_content); // Temporary debugging line
@endphp
...
<script>
    ...
    document.getElementById("toggle-faq").addEventListener("click", function () {
        ...
        allAnswers.forEach(answer => {
            answer.style.height = answer.style.height === "0px" || answer.style.height === "" ? answer.scrollHeight + "px" : "0px";
        });
