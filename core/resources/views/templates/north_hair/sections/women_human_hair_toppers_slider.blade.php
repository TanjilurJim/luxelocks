@php
    $content = getMultipleContent('women_human_hair_topper_slider.element', true);
@endphp
        ...
        @foreach($content as $slider)
            ...
            <div class="relative">
                ...
                <img src="{{ property_exists($dataValues, 'slider_banner') && $dataValues->slider_banner
                        ? asset('assets/images/frontend/women_human_hair_topper_slider/' . $dataValues->slider_banner)
                ...
                {{-- <img src="{{ property_exists($dataValues, 'mobile_slider') && $dataValues->mobile_slider
                        ? asset('assets/images/frontend/women_human_hair_topper_slider/' . $dataValues->mobile_slider)
