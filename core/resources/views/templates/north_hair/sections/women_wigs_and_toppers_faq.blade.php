@php
    $faq_content = getMultipleContent('women_wigs_and_toppers_faq.element', true);
@endphp
        ...
        <div id="faq-container" class="max-w-screen-xl px-4 mx-auto mt-8 flex flex-col gap-5">
            @foreach ($faq_content as $faq)
                @php
                    ...
                    $dataValues = is_string($faq->data_values) ? json_decode($faq->data_values) : $faq->data_values;
                @endphp
