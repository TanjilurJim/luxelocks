@php
    // Get the content for the Tape-In Hair Extensions Section
    $content = getContent('extensions_tape_hair_extensions_product.', true);
...
@if ($data_values)
    ...
    <section>
        <div class="max-w-screen-xl mx-auto px-4 mt-2">
            <h2 class="md:text-[30px] text-[26px] font-bold">{{ $data_values->title ?? 'Tape-In Hair Extensions' }}</h2>
