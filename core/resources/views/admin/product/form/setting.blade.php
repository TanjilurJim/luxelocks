                        ...
                        <div class="tab-content" id="v-pills-tabContent">
                            ...
                            {{-- @if (@$product)
                                <div class="tab-pane fade" id="specifications" role="tabpanel"
                                    ...
                                    @includeIf('admin.product.partials.specifications')
                                </div>
                            @endif --}}
...
@push('script')
    <script>
        (function($) {
            ...
            const handleSummaryTabShow = () => {
                const textareaField = 'productSummary';

                if (!window.nicEditorInstanceForSummary) {
                    window.nicEditorInstanceForSummary = new nicEditor({
                        fullPanel: true
                    });
                }

                if (window.nicEditorInstanceForSummary.nicInstances.filter((element) => element.e.id ===
                        textareaField).length === 0) {
                    window.nicEditorInstanceForSummary.panelInstance(textareaField);
                }
            }

            // Initialize Summary editor when the page loads
            $(document).ready(() => {
                handleSummaryTabShow();
            });

            // $('#summary-tab').on('shown.bs.tab', () => handleSummaryTabShow());
