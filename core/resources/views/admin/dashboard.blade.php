...
@section('panel')
    <div class="row gy-4">
        ...
        <div class="col-xxl-3 col-sm-6">
            <div class="card h-100">
                <div class="card-body p-0">
                    <h5 class="card-title pt-3 ps-3">@lang('Quotation Status')</h5>
                    <div class="row gy-3 counting-widget">
                        <!-- Pending Quotes -->
                        <div class="col-12">
                            <x-widget
                                value="{{ $quotesPendingCount }}"
                                title="Pending"
                                style="2"
                                bg="white"
                                color="danger"
                                icon="las la-money-bill-wave"
                                link="{{ route('admin.quotes.pending') }}"
                                icon_style="solid"
                                overlay_icon=0
                            />
                        </div>
                        ...
                        <div class="col-12">
                            <x-widget
                                value="{{ $quotesApprovedCount }}"
                                title="Approved"
                                style="2"
                                bg="white"
                                color="success"
                                icon="las la-user-check"
                                link="{{ route('admin.quotes.approved') }}"
                                icon_style="solid"
                                overlay_icon=0
                            />
                        </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row g-3 account-widget">
                        ...
                        <div class="col-sm-6">
                            <x-widget value="{{ $widget['active_users'] }}" title="Active" style="2"
                                bg="white" color="green" icon="la la-user-check"
                                link="{{ route('admin.users.active') }}" icon_style="solid" overlay_icon=0 />
                        </div>
