...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $quotesPendingCount   = Quote::where('status', 'pending')->count();
        $quotesApprovedCount  = Quote::where('status', 'approved')->count();
        ...
        return view('admin.dashboard', compact('pageTitle', 'widget', 'chart', 'deposit', 'topSellingProducts', 'latestUser', 'recentOrders','quotesPendingCount',
        'quotesApprovedCount'));
    }
